...
const IDCardsPage = () => {
  ...
  const getDepartmentBadgeStyle = (dept) => {
    switch (dept) {
      case 'COI (Center Of Information)': return { topBar: 'bg-indigo-500', iconBg: 'bg-indigo-50 border-indigo-200 text-indigo-600', text: 'group-hover:text-indigo-600', badge: 'bg-indigo-50 text-indigo-800 border-indigo-200', bg: 'bg-white border-2 border-slate-300' };
      case 'Sales And Marketing': return { topBar: 'bg-rose-500', iconBg: 'bg-rose-50 border-rose-200 text-rose-600', text: 'group-hover:text-rose-600', badge: 'bg-rose-50 text-rose-800 border-rose-200', bg: 'bg-white border-2 border-slate-300' };
      case 'Software Development': return { topBar: 'bg-sky-500', iconBg: 'bg-sky-50 border-sky-200 text-sky-600', text: 'group-hover:text-sky-600', badge: 'bg-sky-50 text-sky-800 border-sky-200', bg: 'bg-white border-2 border-slate-300' };
    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200/80">
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium">Manage employee identity badges, Canva templates, and security QR code assets.</p>
        </div>
        ...
        {isAdmin && (
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            <span className="font-mono text-xs font-extrabold text-slate-700 bg-slate-100 px-3 py-2 rounded-xl border border-slate-200/80">
